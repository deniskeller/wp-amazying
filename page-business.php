...
<?php get_template_part('src/pages/business/start/start'); ?>
<?php get_template_part('src/pages/business/form/form'); ?>
<?php get_template_part('src/pages/business/tovarooborot/tovarooborot'); ?>
<?php get_template_part('src/pages/business/form2/form2'); ?>
<?php get_template_part('src/pages/business/how-get/how-get'); ?>
